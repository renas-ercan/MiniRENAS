...
def gen_refl_model_diff1_HbO2(parameters, xdata, WF, HHb):
    """
    Generates the first derivative of the model reflectance for HbO2 fitting.
    """
    coeff = load_extinction_coeff()
    rho = 30  # Source-detector separation

    # Unpack parameters
    # WF and HHb are fixed and passed separately
    HbO2 = parameters[2]
    a = parameters[3]
    b = parameters[4]
    ...
    return diff_1_model_refl_smoothed
